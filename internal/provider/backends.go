...
func newOllama(ctx context.Context, cfg *Config) (model.ChatModel, error) {
	baseURL := cfg.BaseURL
	if baseURL == "" {
...
func newOpenAI(ctx context.Context, cfg *Config) (model.ChatModel, error) {
	if cfg.APIKey == "" {
...
func newAzure(ctx context.Context, cfg *Config) (model.ChatModel, error) {
	if cfg.APIKey == "" {
...
func newBedrock(ctx context.Context, cfg *Config) (model.ChatModel, error) {
...
func newGemini(ctx context.Context, cfg *Config) (model.ChatModel, error) {
	if cfg.APIKey == "" {
